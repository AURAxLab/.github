...
**Agentes · Usuarios · Realidad · Algoritmos · eXperiencias**
...
Nuestra filosofía se basa en que la verdadera innovación surge en la cooperación heterotécnica y en la intersección de las múltiples áreas del saber humano. Utilizamos la tecnología (**AURA**) como medio para diseñar, mejorar y asegurar nuevas **eXperiencias** humanas (**x**), con un énfasis especial en áreas críticas como la salud, la educación, el esparcimiento, y la seguridad.

### Nuestro Enfoque: El Factor AURA
...
AURAxLab es dirigido y fundado por:

### **Alexander Barquero Elizondo, Ph.D.**

El Dr. Barquero lidera la visión científica y estratégica del laboratorio, aportando su experiencia en investigación para fomentar la innovación tecnológica en la UCR y fuera de sus fronteras.

* **Profesor Invitado**, Universidad de Costa Rica (UCR).
* **Docente**, Escuela de Ciencias de la Computación e Informática (ECCI).
* **Investigador**, Centro de Investigaciones en Tecnologías de la Información y Comunicación (CITIC).

---

## Afiliaciones Institucionales

AURAxLab opera dentro del ecosistema académico y de investigación de la **Universidad de Costa Rica (UCR)**, manteniendo una estrecha vinculación con:

* [Escuela de Ciencias de la Computación e Informática (ECCI)](https://www.ecci.ucr.ac.cr/)
* [Centro de Investigaciones en Tecnologías de la Información y Comunicación (CITIC)](https://citic.ucr.ac.cr/)

---

## Colaboración y Contacto

Estamos siempre abiertos a la colaboración académica, proyectos con la industria y a recibir estudiantes apasionados por la investigación.
